...
from baseline.algo import GP_loc_vec_secure, GP_post_func_vec_secure
from ldp.algo import ldp_lap_vec_secure
from smooth.algo import smooth_mechanism_tvec_secure, kde_smooth_vec
...
filelog = None
folder_prefix = './results/test_nymvc1w_secure/test_kde_<gcell>_<eps>_n<n>k<trange>'
mreps = 10
gcell = 60
...
pg3 = 1.0/3.0
mech_base0 = lambda arr_x, t: [func(np.transpose(GP_loc_vec_secure(x, eps, mreps=mreps)),np.reshape(t,(2,1))) for x in arr_x]
mech_base1 = lambda arr_x, t: GP_post_func_vec_secure(arr_x, eps, (lambda x: GP_func1(x,t)), sens1, post_func1, mreps)
mech_base2 = lambda arr_x, t: GP_post_func_vec_secure(arr_x, eps, (lambda x: GP_func2(x,t)), sens2, post_func2, mreps)
mech_smootht3 = lambda arr_x, t: kde_smooth_vec(arr_x, eps, (lambda x: func(x,t)), t, h, mreps=mreps, smooth_mech_vec=smooth_mechanism_tvec_secure,nu=3,pg=pg3)
mech_lap = lambda arr_x, t: ldp_lap_vec_secure(arr_x, (lambda x: func(x,t)), epsL, mreps, sensL)
